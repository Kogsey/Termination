...
namespace Termination.Items.InvI
{
	public class Atomic : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName
			.SetDefault("Atomic reconstructor");
			Tooltip.SetDefault("the atomic reconstructor is an inventory crafter");
		}
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(null, "Sireniumbar", 3);
