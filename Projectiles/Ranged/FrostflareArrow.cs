...
namespace Termination.Projectiles.Ranged
{
	public class FrostflareArrow : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Frostflare arrows");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			aiType = ProjectileID.WoodenArrowFriendly;           //Act exactly like default Bee
		}
