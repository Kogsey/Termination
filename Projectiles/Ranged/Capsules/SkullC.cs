...
namespace Termination.Projectiles.Ranged.Capsules
{
     ...
     : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("Cur.. A skull");     //The English name of the projectile
        ...
        public override void SetDefaults()
        {
            ...
            projectile.aiStyle = 8;             //The ai style of the projectile, please reference the source code of Terraria
            ...
            aiType = ProjectileID.WaterBolt;           //Act exactly like default Bee
        }
