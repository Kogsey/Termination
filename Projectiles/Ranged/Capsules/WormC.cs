...
namespace Termination.Projectiles.Ranged.Capsules
{
    public class WormC : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Wooooooooooormy *cough* I mean Worm");     //The English name of the projectile
        ...
        {
            projectile.width = 21;               //The width of projectile hitbox
            projectile.height = 39;              //The height of projectile hitbox
            ...
            aiType = ProjectileID.MagicMissile;           //Act exactly like default Bee
        }
