...
{
    public class BallOMetalPro2 : ModProjectile
    {
        private const float RotationSpeed = 0.05f;
        private const float Distanse = 400;
        ...
        {
            Texture2D texture = ModContent.GetTexture("Engineer/Projectiles/melee/BallOMetal_Chain2");
