...
{
    public class ElectronicEyeThornBall : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            projectile.aiStyle = 277;             //The ai style of the projectile, please reference the source code of Terraria
            ...
            aiType = ProjectileID.ThornBall;   //Act exactly like default Eye Laser from rastropod
