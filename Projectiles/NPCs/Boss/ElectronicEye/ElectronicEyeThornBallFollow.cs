...
{
    public class ElectronicEyeThornBallFollow : ModProjectile
    {
        private float timeuntilframe = 0;
        private float timeuntilexplode = 500;

        private float timeuntilshoot = 0;

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Seek:OBLITERATE");     //The English name of the projectile
        ...
        public override void SetDefaults()
        {
            ...
            projectile.height = 32;               //The height of projectile hit-box
            ...
            aiType = ProjectileID.ThornBall;   //Act exactly like default Eye Laser from gastropod
        ...
        public override void AI()
        {
            ...
            {
                projectile.position += Main.player[projectile.owner].velocity/2;
            }

            if (timeuntilshoot >= 180 && timeuntilshoot <= 182)
            {
                Vector2 shootVel = Main.player[projectile.owner].Center - projectile.Center;
                shootVel.Normalize();
                shootVel *= (new Vector2(Main.rand.Next(8, 12), Main.rand.Next(8, 12)).RotatedByRandom(MathHelper.ToRadians(30)));
