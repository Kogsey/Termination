...
{
    public class ElectronicEyeThornBallAngry : ModProjectile
    {
        ...
        {
            projectile.width = 64;               //The width of projectile hit-box
            projectile.height = 64;              //The height of projectile hit-box
        ...
        public override void AI()
        {
            if (timeuntilshoot >= 180 && timeuntilshoot <= 182)
            {
                ...
                shootVel.Normalize();
                shootVel *= 2*(new Vector2(Main.rand.Next(8, 12), Main.rand.Next(8, 12)).RotatedByRandom(MathHelper.ToRadians(30)));
