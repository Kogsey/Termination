...
{
    public class ElectronicDroneLazer : ModProjectile
    {
        public override string Texture
        {
            get { return "Terraria/Projectile_" + ProjectileID.EyeBeam; }
        }

        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Just a generic laser");     //The English name of the projectile
