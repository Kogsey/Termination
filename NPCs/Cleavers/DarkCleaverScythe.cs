...
{
	public class DarkCleaverScythe : ModProjectile
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Dark Scythe");     //The English name of the projectile
		...
		public override void SetDefaults()
		{
			...
			projectile.aiStyle = 274;             //The ai style of the projectile, please reference the source code of Terraria
			...
			aiType = ProjectileID.DeathSickle;           //Act exactly like default Bee
		}
